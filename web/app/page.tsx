...
const PRODUCTS = [
  {
    ...
    d: 'Anonymous WireGuard exits in 10 countries across 4 continents. Pick where you surface.',
    href: '#app',
    cta: 'activate →',
  },
  {
      ...
      <main id="top" className="page">
        ...
        <section className="hero">
          <div className="hero-copy">
            ...
            <p className="lead">
              An anonymous layer wrapped around the chain: exit nodes in 10 countries,
              private search, an anonymous browser and private swaps. No accounts, no
              logs — hold $UNK and the layer is yours.
            </p>
            ...
            <p className="statusline">
              <span className="blink">●</span> layer: 10 countries · 4 continents &nbsp;·&nbsp; logs: 0
            </p>
          </div>
